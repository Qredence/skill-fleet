...
export const JobsTab = ({ apiUrl, isActive }) => {
    ...
    return (React.createElement(Box, { flexDirection: "column", paddingX: 2, height: 20 },
        ...
        runningJobs.length > 0 && (React.createElement(Box, { flexDirection: "column", marginTop: 1 },
            React.createElement(Text, { color: "cyan", bold: true },
                "\u23F3 Running (",
                runningJobs.length,
                ")"),
            runningJobs.map((job) => (React.createElement(Box, { key: job.id, marginTop: 1, flexDirection: "column" },
                ...
                React.createElement(Text, { color: "gray" },
                    ...
                    job.progress || 0,
                    "% complete")))))),
        completedJobs.length > 0 && (React.createElement(Box, { flexDirection: "column", marginTop: 1 },
            React.createElement(Text, { color: "green", bold: true },
                "\u2705 Completed (",
                completedJobs.length,
                ")"),
            completedJobs.slice(0, 3).map((job) => (React.createElement(Box, { key: job.id, marginTop: 1 },
                ...
                React.createElement(Text, { color: "gray" },
                    " - ",
                    job.type)))))),
        failedJobs.length > 0 && (React.createElement(Box, { flexDirection: "column", marginTop: 1 },
            React.createElement(Text, { color: "red", bold: true },
                "\u274C Failed (",
                failedJobs.length,
                ")"),
            failedJobs.slice(0, 2).map((job) => (React.createElement(Box, { key: job.id, marginTop: 1, flexDirection: "column" },
                React.createElement(Box, { flexDirection: "row" },
                    React.createElement(Text, { color: "red" }, "\u2717"),
                    React.createElement(Text, { color: "white" },
                        " ",
                        job.id)),
                job.error && (React.createElement(Text, { color: "gray" },
                    "  Error: ",
        ...
        React.createElement(Box, { marginTop: 2, borderStyle: "single", borderColor: "gray", paddingX: 1 },
            React.createElement(Text, { color: "gray" }, "\uD83D\uDCA1 Commands: /status job_id | /optimize | Press R to refresh"))));
};
