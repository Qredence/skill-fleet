...
export const OptimizationTab = ({ apiUrl, isActive, onOptimize, }) => {
    ...
    return (React.createElement(Box, { flexDirection: "column", paddingX: 2, height: 20 },
        ...
        React.createElement(Box, { marginTop: 1, marginBottom: 1, borderStyle: "round", borderColor: "green", paddingX: 1 },
            React.createElement(Box, { flexDirection: "column" },
                React.createElement(Text, { color: "green", bold: true }, "\u26A1 Reflection Metrics - FASTEST OPTIMIZER"),
                React.createElement(Text, { color: "gray" }, "\u2022 4400x faster than MIPROv2 (<1 second)"),
                React.createElement(Text, { color: "gray" }, "\u2022 Cost: $0.01-0.05 (vs $5-10 for MIPROv2)"),
                React.createElement(Text, { color: "gray" }, "\u2022 Quality: +1.5% improvement over baseline"),
                React.createElement(Text, { color: "cyan" }, "Quick start: /optimize reflection_metrics trainset_v4.json"))),
        step === "optimizer" && (React.createElement(Box, { flexDirection: "column" },
        ...
        step === "trainset" && (React.createElement(Box, { flexDirection: "column" },
        ...
        step === "confirm" && (React.createElement(Box, { flexDirection: "column" },
            ...
            React.createElement(Text, { color: "green" },
                "\u2713 Trainset: ",
                selectedTrainset),
            React.createElement(Box, { marginTop: 2, borderStyle: "double", borderColor: "yellow", paddingX: 1 },
                React.createElement(Box, { flexDirection: "column" },
                    ...
                    React.createElement(Box, { marginTop: 1 },
                        React.createElement(Text, { color: "gray" },
                            ...
                            " examples - Use ",
                            selectedOptimizer,
                            " algorithm - Save results to config/optimized/")),
                    React.createElement(Box, { marginTop: 1 },
                        React.createElement(Text, { color: "cyan" }, "Press Enter to confirm, or Esc to cancel")))))),
        React.createElement(Box, { marginTop: 2, borderStyle: "single", borderColor: "gray", paddingX: 1 },
            React.createElement(Box, { flexDirection: "column" },
                ...
                React.createElement(Text, { color: "gray" }, "reflection_metrics: <1s, $0.01, +1.5% quality"),
                React.createElement(Text, { color: "gray" }, "mipro: 4-6min, $5-10, +10-15% quality"),
                React.createElement(Text, { color: "gray" }, "bootstrap: 30s, $0.50, +5-8% quality")))));
};
