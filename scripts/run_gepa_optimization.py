...
from skill_fleet.core.dspy.metrics.gepa_reflection import (
...
def create_comparison_results(
    ...
    return {
        ...
        "gepa_improvement_pct": (gepa_score - baseline_score) / baseline_score * 100 if baseline_score > 0 else 0,
    }
...
def main():
    ...
    improvement_pct = (improvement / baseline_results['score'] * 100) if baseline_results['score'] > 0 else 0
