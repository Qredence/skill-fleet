...
try:
    # Phase 1
    from skill_fleet.core.dspy.monitoring import ModuleMonitor, ExecutionTracer, MLflowLogger
    ...
    # Phase 3
    from skill_fleet.core.dspy.modules.ensemble import EnsembleModule, BestOfN, MajorityVote
    from skill_fleet.core.dspy.modules.phase0_research import GatherExamplesModule
    from skill_fleet.core.dspy.versioning import ProgramRegistry, ABTestRouter
...
try:
    ...
    if trainset:
        ...
        if missing:
            ...
            print(f"✅ Training examples have correct structure")
...
try:
    ...
    prediction = dspy.Prediction(
        ...
        skill_metadata=type('obj', (object,), {
            'name': 'test-skill',
...
try:
    from skill_fleet.api.routes.optimization import router, OptimizeRequest
