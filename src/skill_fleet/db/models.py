...
class Skill(Base):
    ...
    def __repr__(self) -> str:
        return f"<Skill(skill_id={self.skill_id}, skill_path='{self.skill_path}', name='{self.name}')>"
...
class TaxonomyCategory(Base):
    ...
    parent_id: Mapped[Optional[int]] = mapped_column(
        Integer,
        ForeignKey('taxonomy_categories.category_id'),
        nullable=True
    )
...
class TaxonomyClosure(Base):
    ...
    ancestor_id: Mapped[int] = mapped_column(
        Integer,
        ForeignKey('taxonomy_categories.category_id', ondelete='CASCADE'),
        primary_key=True
    )
...
class Capability(Base):
    ...
    name: Mapped[str] = mapped_column(String(128), nullable=False)
    description: Mapped[str] = mapped_column(Text, nullable=False)
    test_criteria: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    sort_order: Mapped[int] = mapped_column(Integer, default=0)
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True),
        nullable=False,
...
class SkillDependency(Base):
    ...
    dependency_skill: Mapped['Skill'] = relationship(
        'Skill',
        foreign_keys=[dependency_skill_id],
        back_populates='dependencies_as_dependency'
    )
...
class SkillFile(Base):
    ...
    binary_data: Mapped[Optional[bytes]] = mapped_column(BYTEA, nullable=True)
...
class Job(Base):
    ...
    task_description_refined: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    intended_taxonomy_path: Mapped[Optional[str]] = mapped_column(String(512), nullable=True)
    draft_path: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    validation_score: Mapped[Optional[float]] = mapped_column(Integer, nullable=True)
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True),
        nullable=False,
        server_default=func.now()
...
class DeepUnderstandingState(Base):
    ...
    understanding_summary: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    user_problem: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    user_goals: Mapped[Optional[list[str]]] = mapped_column(ARRAY(String), nullable=True)
...
class TDDWorkflowState(Base):
    ...
    rationalizations_identified: Mapped[Optional[list[str]]] = mapped_column(ARRAY(String), nullable=True)
...
class ValidationReport(Base):
    ...
    errors: Mapped[Optional[list[str]]] = mapped_column(ARRAY(String), nullable=True)
    warnings: Mapped[Optional[list[str]]] = mapped_column(ARRAY(String), nullable=True)
    checks_performed: Mapped[Optional[list[str]]] = mapped_column(ARRAY(String), nullable=True)
    quality_score: Mapped[Optional[float]] = mapped_column(Integer, nullable=True)
    completeness_score: Mapped[Optional[float]] = mapped_column(Integer, nullable=True)
    compliance_score: Mapped[Optional[float]] = mapped_column(Integer, nullable=True)
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True),
        nullable=False,
        server_default=func.now()
...
class SkillTestCoverage(Base):
    ...
    coverage_percent: Mapped[Optional[float]] = mapped_column(Integer, nullable=True)
...
class UsageEvent(Base):
    ...
    task_id: Mapped[Optional[UUID]] = mapped_column(UUID, nullable=True)
...
class OptimizationJob(Base):
    ...
    trainset_file: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    training_skills: Mapped[Optional[list[str]]] = mapped_column(ARRAY(String), nullable=True)
    status: Mapped[str] = mapped_column(String(32), nullable=False, default='pending')
    result_score: Mapped[Optional[float]] = mapped_column(Integer, nullable=True)
    optimized_program_path: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    training_time_seconds: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
