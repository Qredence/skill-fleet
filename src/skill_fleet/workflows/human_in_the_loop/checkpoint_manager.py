...
from ...core.dspy.modules.hitl import (
...
class HITLCheckpointManager:
    ...
    async def determine_strategy(
        ...
        try:
            result = await self.strategy_module.aforward(
            ...
            if enable_mlflow:
                log_phase_metrics("hitl_strategy", {
    ...
    async def generate_clarifying_questions(
        ...
        try:
            result = await self.clarifying_questions_module.aforward(
                task_description=task_description,
            ...
            if enable_mlflow:
                log_phase_metrics("clarifying_questions", {
    ...
    async def confirm_understanding(
        ...
        try:
            result = await self.confirm_understanding_module.aforward(
                task_description=task_description,
            ...
            if enable_mlflow:
                log_phase_metrics("confirm_understanding", {
    ...
    async def generate_preview(
        ...
        try:
            result = await self.preview_generator_module.aforward(
                skill_content=skill_content,
                metadata=metadata,
            )

            if enable_mlflow:
                log_phase_metrics("preview_generation", {
    ...
    async def analyze_feedback(
        ...
        try:
            result = await self.feedback_analyzer_module.aforward(
                user_feedback=user_feedback,
                current_content=current_content,
            )

            if enable_mlflow:
                log_phase_metrics("feedback_analysis", {
    ...
    async def format_validation_results(
        ...
        try:
            result = await self.validation_formatter_module.aforward(
                validation_report=validation_report,
                skill_content=skill_content,
            )

            if enable_mlflow:
                log_phase_metrics("validation_formatting", {
    ...
    async def plan_refinement(
        ...
        try:
            result = await self.refinement_planner_module.aforward(
            ...
            if enable_mlflow:
                log_phase_metrics("refinement_planning", {
    ...
    async def assess_readiness(
        ...
        try:
            result = await self.readiness_assessor_module.aforward(
                phase=phase,
            ...
            if enable_mlflow:
                log_phase_metrics("readiness_assessment", {
